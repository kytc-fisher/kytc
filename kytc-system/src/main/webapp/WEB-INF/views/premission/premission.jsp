...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/premission/premission.js"></script>
<div id="kytc_system_premission_premission_main_div" style="width:100%;height:100%;" class="premission_list">
