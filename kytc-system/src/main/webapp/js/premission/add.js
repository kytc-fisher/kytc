 ...
 */
$(function(){
	var main_div = $("#kytc_system_premission_add_main_div");
	var parent_main_div = $("#kytc_system_premission_main_div");
	var parent_main_div_list = $("#kytc_system_premission_main_div_list");
	$("#kytc_system_premission_add_main_div_project").dic({
		type:"KYTC_PROJECT"
	});
	$("#kytc_system_premission_add_main_div_moudle").dic({
		parentType:"KYTC_PROJECT",
		type:"KYTC_MODULE",
		parentDic:$("#kytc_system_premission_add_main_div_project")
	});
	$("#kytc_system_premission_add_main_div_menu").dic({
		parentType:"KYTC_MODULE",
		type:"KYTC_MENU",
		parentDic:$("#kytc_system_premission_add_main_div_moudle")
	});
	$("#kytc_system_premission_add_main_div_operator").dic({
		type:"KYTC_OPERATOR"
	});
